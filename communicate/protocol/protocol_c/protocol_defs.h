...
#define PROTOCOL_DATA_VER_FULL  20250925113135ULL
#define PROTOCOL_DATA_VER       0x2F
...
#define VAR_ARM_HIGH_GRIP_TO_RESET_GRIPPING 0x18
#define VAR_ARM_RESET_GRIPPING_TO_SHOT 0x19
#define VAR_TEST_VAR_U8 0x1C
#define VAR_ARM_RESET_TO_STORE 0x1F
#define VAR_BASE_MOVE_BACKWARD_FAST 0x21
#define VAR_ARM_LOW_GRIP_TO_RESET_GRIPPING 0x26
#define VAR_BASE_MOVE_FORWARD_FAST_EX 0x29
#define VAR_ARM_RESET_TO_HIGH_PREPARE 0x2E
#define VAR_ARM_LOW_PREPARE_TO_LOW_GRIP 0x30
#define VAR_ARM_RESET_GRIPPING_TO_STORE 0x32
...
#define VAR_ARM_HIGH_PREPARE_TO_HIGH_GRIP 0xAA
...
#define VAR_ARM_STORE_TO_RESET_GRIPPING 0xCF
...
#define VAR_ARM_HIGH_GRIP_TO_RESET_GRIPPING_SIZE 1
#define VAR_ARM_RESET_GRIPPING_TO_SHOT_SIZE 1
#define VAR_TEST_VAR_U8_SIZE 1
#define VAR_ARM_RESET_TO_STORE_SIZE 1
#define VAR_BASE_MOVE_BACKWARD_FAST_SIZE 1
#define VAR_ARM_LOW_GRIP_TO_RESET_GRIPPING_SIZE 1
#define VAR_BASE_MOVE_FORWARD_FAST_EX_SIZE 1
#define VAR_ARM_RESET_TO_HIGH_PREPARE_SIZE 1
#define VAR_ARM_LOW_PREPARE_TO_LOW_GRIP_SIZE 1
#define VAR_ARM_RESET_GRIPPING_TO_STORE_SIZE 1
...
#define VAR_ARM_HIGH_PREPARE_TO_HIGH_GRIP_SIZE 1
...
#define VAR_ARM_STORE_TO_RESET_GRIPPING_SIZE 1
...
static const uint8_t VAR_SIZE_TABLE[256] = {
    ...
    [VAR_ARM_HIGH_GRIP_TO_RESET_GRIPPING] = 1,
    [VAR_ARM_RESET_GRIPPING_TO_SHOT] = 1,
    [VAR_TEST_VAR_U8] = 1,
    [VAR_ARM_RESET_TO_STORE] = 1,
    [VAR_BASE_MOVE_BACKWARD_FAST] = 1,
    [VAR_ARM_LOW_GRIP_TO_RESET_GRIPPING] = 1,
    [VAR_BASE_MOVE_FORWARD_FAST_EX] = 1,
    [VAR_ARM_RESET_TO_HIGH_PREPARE] = 1,
    [VAR_ARM_LOW_PREPARE_TO_LOW_GRIP] = 1,
    [VAR_ARM_RESET_GRIPPING_TO_STORE] = 1,
